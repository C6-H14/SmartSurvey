...
**Note:** The following tasks are deferred and tracked as optional backlog items. They will be promoted to active Phase status when development resources permit.

### Task 22: Zotero Web API Auto-Archive Integration (Optional)
