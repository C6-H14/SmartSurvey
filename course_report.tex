...
\usepackage[paper=a4paper, margin=1.85cm]{geometry}
...
% ============================================================
\begin{center}
  {\LARGE\bfseries SmartSurvey：面向空间异常检测的智能文献综述与知识图谱系统}\\[0.5em]
  {\large —— 项目实现报告（《计算机图形学前沿》期末项目）}\\[1em]
  {\large 钟启帆 \quad PB24010467 \quad 数学科学学院，中国科学技术大学}\\[1em]
...
并物理清洗 RAG 检索标记（\texttt{evidence\_page=}）残留，杜绝内部键名与样式泄漏进手稿。
